<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SilverlightMinWidthResizer.ascx.cs" Inherits="Planet.Rockford.TimeClock.Web.UI.Shared.SilverlightMinWidthResizer" %>
<!--[if IE 6]>
